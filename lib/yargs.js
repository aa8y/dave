...
const argv = yargs
  ...
  .command('build', 'Builds docker image(s).', builder.bind(null))
  .command('push', 'Pushes already built docker image(s).', builder.bind(null))
  .command('test', 'Tests already built docker image(s).', builder.bind(null))
  .command('all', 'Builds, tests and pushes docker images(s).', builder.bind(null))
  .help()
  .argv
